...
<body>
    ...
    <section>
        <div id="footer_content">
            <ul>
                <li><a href="electric_guitar.php">일렉기타</a></li>
                <li><a href="bass_guitar.php">베이스</a></li>
                <li><a href="acoustic_guitar.php">통기타</a></li>
                <li><a>클래식</a></li>
                <li><a>우쿨렐레</a></li>
                <li><a href="bass_amp.php">앰프</a></li>
                <li><a>이펙터</a></li>
                <li><a>픽업/파츠</a></li>
                <li><a>악세사리</a></li>
            </ul>
        ...
        $query = "SELECT * FROM product WHERE category = 'acoustic guitar'";
        ...
        if ($totalPages > 1) {
            ...
            for ($i = 1; $i <= $totalPages; $i++) {
                if ($i == $page) {
                    ...
                    echo "<a href='acoustic_guitar.php?page=$i'>$i</a> ";
                }
            }
            echo "</p>";
        }
